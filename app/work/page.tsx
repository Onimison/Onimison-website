...
const projects = [
  {
    title: "10.8.8 Africa",
    role: "Co-founder · Brand · Community",
    desc: "From a campus magazine at FUTMINNA to 3 editions of FUTCH, 2,000+ event guests, ₦2M+ in partnerships, and a community of 3,000+. Co-founded, co-built, still going.",
    featured: true,
  ...
  },
  {
    ...
    role: "Builder · Architect · Automator",
    desc: "Custom-built tools powered by AI — not just workflows, but actual products. Lead pipelines, content systems, internal ops tools. Each one a case study.",
    featured: false,
    href: "/work/ai-tools",
    external: false,
    tag: "AI & Systems",
  ...
  },
  {
    ...
    desc: "Built a team, created a content engine, and took a page from zero to 2,000+ followers and 100k+ reach in under 6 months. Led with strategy, not luck.",
    featured: false,
  ...
  {
    title: "NIGCOMSAT",
    role: "Content Lead · NYSC · Intern Team",
    desc: "Led a team of interns producing video content for Nigeria's national satellite agency. Directed, strategised, and built a social presence for a government institution.",
    featured: false,
    href: "/work/nigcomsat",
    external: false,
