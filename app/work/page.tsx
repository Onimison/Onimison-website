    ...
    <div className="w-full">
      ...
      <section className="pt-40 pb-20 px-6 md:px-12 max-w-7xl mx-auto relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="absolute top-0 left-0 text-[15rem] md:text-[25rem] font-bebas text-off-white/5 leading-none select-none pointer-events-none -translate-y-1/4 -translate-x-1/4">
            WORK
          </div>
        </div>
      </section>
            ...
            {projects.map((project, i) => (
              ...
              >
                ...
                <div className="mt-auto">
                  <Link href="#contact" className={`inline-flex items-center font-space-mono text-xs uppercase tracking-widest transition-colors ${project.featured ? 'text-bg-dark hover:text-off-white' : 'text-off-white hover:text-rust'}`}>
      ...
      <section className="bg-rust w-full py-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <ScrollReveal delay={0.2}>
            <Link href="/fiction" className="border border-bg-dark text-bg-dark font-space-mono text-sm uppercase tracking-widest px-8 py-4 hover:bg-bg-dark hover:text-rust transition-colors duration-300 whitespace-nowrap">
              Read the Fiction →
            </Link>
          </ScrollReveal>
        </div>
